...
export default function ChartDaily({ data }: any) {
        ...
        if (active && payload && payload.length) {
            ...
            return (
                <div className="dark:bg-zinc-900 bg-white p-4 rounded-md flex flex-col gap-y-1 border border-slate-300 dark:border-zinc-700">
                    <p className='text-gray-900 dark:text-gray-50 text-sm font-medium'>Статистика за {formatDate(new Date(dataPoint.payload.day))}</p>
